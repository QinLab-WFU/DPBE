...
from utils.eval_uncertainty.knn import FaissKNeighbors
import numpy as np
import matplotlib
matplotlib.use('Agg')
...
def evaluate_ausc(dict):
    ...
    # and compute ausc
    ausc, accuracies = plot_sparsification_curve(targets, pidxs, z_muQ, z_sigmaQ, z_muDb, z_sigmaDb, same_source)
...
def plot_sparsification_curve(targets, pidxs, z_muQ, z_sigmaQ, z_muDb, z_sigmaDb, path=None, prefix=None, same_source=True):
