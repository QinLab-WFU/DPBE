...
class Baseclip(nn.Module):
    ...
    def __init__(self,
                 outputDim=64,
                 clipPath = "/home/yuebai/Data/Preload/ViT-B-32.pt",
                 writer=None,
                 saveDir="./result/log",
    ...
    def load_clip(self, clipPath: str) -> tuple:
        ...
        use_part = self.use_part if hasattr(self, 'use_part') else False
        return state_dict["text_projection"].shape[1], build_model(state_dict, use_part)
